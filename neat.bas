...
'DH 08/13/2018
'Gets file format indext for save as dialog
...
End Function
Function GetFormatIndex() As String

'DH 08/13/2018
'Implemented to match save as dialog file format to current file format

Dim FileExtStr As String
Dim FilterIndex As String

    FileExtStr = GetFormatType()
